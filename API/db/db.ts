...
const defaultData: DatabaseSchema = {
  products: [
    {
      id: 'sea-salt-popcorn-snack-size',
      title: 'Sea Salt Mini Popcorn Snack Size 24-Pack',
      count: 24,
      description:
      ...
      flavor: 'Sea Salt',
      images: [
        'https://www.pipsnacks.com/cdn/shop/files/SSPopcorn-SnackSize-24pk-1080fullbox-NOWORDS.png',
        'https://www.pipsnacks.com/cdn/shop/files/snackvspantry_ad_Pipcorn-8_seasaltpopcorn.png',
        'https://www.pipsnacks.com/cdn/shop/products/51MH3AdIDDL.jpg',
        'https://www.pipsnacks.com/cdn/shop/products/51QLyFVmXzL_86c80422-c1f9-4f17-a131-2547b7cb80ee.jpg',
        'https://www.pipsnacks.com/cdn/shop/products/51F_RZ_eofL.jpg',
        'https://www.pipsnacks.com/cdn/shop/products/51vCUrpNqlL_1d37550a-5d06-4e14-8a4d-565afe8a8b08.jpg',
        'https://www.pipsnacks.com/cdn/shop/products/41bymc2WW5L_aa8a2047-3ccd-4bcb-983b-f2283e65843d.jpg',
      ],
      reviews: [],
    },
    {
      id: 'cheddar-cheese-balls-snack-size-24-pack',
      title: 'Cheddar Cheese Balls Snack Size 24-Pack',
      count: 24,
      description:
        'When you crave cheddar, only real cheddar will do – especially when every perfectly poppable bite brings back childhood memories of a snack you loved then and love now. It’s just like you remember – but better tasting, made better (baked, not fried), and with better ingredients that are better for you. All organic, non-GMO and gluten free. Crunched your way to the bottom of the bag on the first open? That’s okay, because Heirloom Makes It Better.',
      size: '24-1oz bags',
      price: 40,
      type: 'Cheese Balls',
      flavor: 'Cheddar',
      images: [
        'https://www.pipsnacks.com/cdn/shop/files/CheddarCheeseballs-SnackSize-24pk-1080fullbox-NOWORDS.png',
